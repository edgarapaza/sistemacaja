...
public class PrintReciboDNI {
     Connection conn=null;
    
    public PrintReciboDNI()
    {
        try
        {
	...
	//JOptionPane.showMessageDialog(null,f.getAbsolutePath()); // Llamamos al método que devuelve la ruta absoluta
        String archivo = f.getAbsolutePath() + "\\report\\reporteDNI.jasper";
        ...
        //String archivo = "C:\\Users\\INFORMATICA\\Documents\\NetBeansProjects\\sistemacaja\\src\\sistemacaja\\reporteDNI.jasper";
