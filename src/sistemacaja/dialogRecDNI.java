...
public final class dialogRecDNI extends javax.swing.JDialog {
     ...
     */
    public dialogRecDNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogRecDNI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogRecDNI dialog = new dialogRecDNI(new javax.swing.JFrame(), true);
