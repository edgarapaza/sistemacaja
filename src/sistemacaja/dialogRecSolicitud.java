...
public final class dialogRecSolicitud extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 15, -1, -1));
        ...
        getContentPane().add(txtNumSolicitud, new org.netbeans.lib.awtextra.AbsoluteConstraints(115, 12, 101, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogRecSolicitud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogRecSolicitud dialog = new dialogRecSolicitud(new javax.swing.JFrame(), true);
